            ...
            if ("audio" === t(this).prop("tagName").toLowerCase()) {
                ...
                f) {
                    ...
                    h.find(".play-pause-btn").on("click", function() {
                        return h.hasClass("player-playing") ? (h.removeClass("player-playing").addClass("player-paused"),
                        b.pause()) : (h.addClass("player-playing").removeClass("player-paused"),
                        b.play()),
                        !1
                    }),
                    i.replaceWith(h),
                    d) {
                        ...
                        e.addEventListener(x, function() {
                            var t;
                            ((t = y()) && e[t] || "hidden" === function() {
                                if ("visibilityState"in e)
                                    return "visibilityState";
                                for (var t = 0; t < l.length; t++)
                                    if (l[t] + "VisibilityState"in e)
                                        return l[t] + "VisibilityState";
                                return null
                            }()) && (h.removeClass("player-playing").addClass("player-paused"),
                            b.pause())
                        }, !1)
